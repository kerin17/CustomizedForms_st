...
#two fragments; changes applied/re-run within each fragment
...
def toggle_and_text():
    ...
    #st.rerun(scope="app") ##meaning rerun the entire app
    #st.rerun(scope="fragment")  ##default, rerun this fragment only
